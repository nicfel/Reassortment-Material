function [] = getSubsampledDatasetSegNr(virus, workingdir, dateorder, nrSampled)
% same as getSubsampledDataset but uses segment numbers instead of segment
% names
cd(workingdir)


% define the segments
segments = {'4', '7', '6', '5', '8', '3', '1', '2'};
